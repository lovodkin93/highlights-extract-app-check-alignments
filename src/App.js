...
import mturk_results_json_file from './data/mturk_results/assignments_results2.json'
import submitted_tasks_ids_json_file from './data/mturk_results/submitted_tasks_ids2.json'
...
/**************************************************************************************************************/
    ...
    useEffect(() => {
      ...
      const getTasks = () => {
        ...
        setDocParagraphBreaks(json_file['0']["doc_paragraph_breaks"]) // update this from "json_file" to "mturk_results_json_file" when I start saving this in the task and '0' to the equivalent key
        fetch(`/`).then(
          res => console.log(res)
        )
